...
const SvgMenuItemTeaCup = (props: SVGProps<SVGSVGElement>) => (
    <svg
        width='24'
        height='24'
        viewBox='0 0 24 24'
        ...
        {...props}
    >
        <rect width='24' height='24' fill='url(#pattern0_6002_19920)' />
        <defs>
            <pattern
                id='pattern0_6002_19920'
                patternContentUnits='objectBoundingBox'
                width='1'
                height='1'
            >
                <use
                    xlinkHref='#image0_6002_19920'
                    transform='translate(0.125 0.144216) scale(0.0078125)'
                />
            </pattern>
            <image
                id='image0_6002_19920'
                width='96'
                height='96'
...
const Memo = memo(SvgMenuItemTeaCup);
