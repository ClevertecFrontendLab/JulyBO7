...
const SvgMenuItemInternationalFood = (props: SVGProps<SVGSVGElement>) => (
    <svg
        width='24'
        height='24'
        viewBox='0 0 24 24'
        ...
        {...props}
    >
        <rect width='24' height='24' fill='url(#pattern0_6002_19857)' />
        <defs>
            <pattern
                id='pattern0_6002_19857'
                patternContentUnits='objectBoundingBox'
                width='1'
                height='1'
            >
                <use
                    xlinkHref='#image0_6002_19857'
                    transform='translate(0.166667 0.166667) scale(0.00694444)'
                />
            </pattern>
            <image
                id='image0_6002_19857'
                width='96'
                height='96'
...
const Memo = memo(SvgMenuItemInternationalFood);
