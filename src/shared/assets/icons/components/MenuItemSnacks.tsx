...
const SvgMenuItemSnacks = (props: SVGProps<SVGSVGElement>) => (
    <svg
        width='24'
        height='24'
        viewBox='0 0 24 24'
        ...
        {...props}
    >
        <rect width='24' height='24' fill='url(#pattern0_6002_4207)' />
        <defs>
            <pattern
                id='pattern0_6002_4207'
                patternContentUnits='objectBoundingBox'
                width='1'
                height='1'
            >
                <use
                    xlinkHref='#image0_6002_4207'
...
const Memo = memo(SvgMenuItemSnacks);
