...
const SvgHomeOutline = (props: IconProps) => (
    ...
    >
        ...
        <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M10.9395 2.25C11.2208 1.96879 11.6022 1.81082 12 1.81082C12.3977 1.81082 12.7792 1.96879 13.0605 2.25L23.031 12.219C23.1718 12.3598 23.2509 12.5508 23.2509 12.75C23.2509 12.9492 23.1718 13.1402 23.031 13.281C22.8901 13.4218 22.6991 13.5009 22.5 13.5009C22.3008 13.5009 22.1098 13.4218 21.969 13.281L12 3.3105L2.03097 13.281C1.89014 13.4218 1.69913 13.5009 1.49997 13.5009C1.30081 13.5009 1.1098 13.4218 0.968971 13.281C0.828141 13.1402 0.749023 12.9492 0.749023 12.75C0.749023 12.5508 0.828141 12.3598 0.968971 12.219L10.9395 2.25Z'
            fill='black'
            fillOpacity='0.92'
        />
    </Icon>
