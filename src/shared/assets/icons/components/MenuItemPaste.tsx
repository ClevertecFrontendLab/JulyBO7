...
const SvgMenuItemPaste = (props: SVGProps<SVGSVGElement>) => (
    <svg
        width='24'
        height='24'
        viewBox='0 0 24 24'
        ...
        {...props}
    >
        <rect width='24' height='24' fill='url(#pattern0_6002_19927)' />
        <defs>
            <pattern
                id='pattern0_6002_19927'
                patternContentUnits='objectBoundingBox'
                width='1'
                height='1'
            >
                <use
                    xlinkHref='#image0_6002_19927'
                    transform='translate(0.151406 0.146862) scale(0.0078125)'
                />
            </pattern>
            <image
                id='image0_6002_19927'
                width='96'
                height='96'
...
const Memo = memo(SvgMenuItemPaste);
