export const STEP_1 = 'Шаг 1. Личная информация';
export const STEP_2 = 'Шаг 2. Логин и пароль';
export const VERIFICATION_MODAL_HEADER = 'Остался последний шаг. Нужно верифицировать ваш e-mail';
export const VERIFICATION_ERROR_MODAL_HEADER = 'Упс! Что-то пошло не так';
export const VERIFICATION_ERROR_MODAL_TEXT =
